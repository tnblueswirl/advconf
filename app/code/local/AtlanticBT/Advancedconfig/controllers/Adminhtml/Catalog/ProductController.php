 ...
 * Tasks
 * 
 * TODO: init config price rules - Populate rules table existing price rules
 * TODO: detect prices from existing price rules to populate rules table
 * TODO: save config price rules
 */
