 ...
 */
class AtlanticBT_Advancedconfig_Block_Adminhtml_Catalog_Product_Edit_Tab_Super_Config
    extends Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Super_Config
{
    ...
    public function __construct()
    {
        ...
        $this->setTemplate('atlanticbt/advancedconfig/catalog/product/edit/super/config.phtml');
